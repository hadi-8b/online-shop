...
class CategoryServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // بارگذاری فایل‌های روت
        // $this->loadRoutesFrom(module_path('Category', 'Routes/api.php'));

        // بارگذاری فایل‌های ترجمه (در صورت وجود)
        // $this->loadTranslationsFrom(module_path('Category', 'Resources/lang'), 'category');

        // بارگذاری فایل‌های ویو (در صورت وجود)
        // $this->loadViewsFrom(module_path('Category', 'Resources/views'), 'category');
    }
